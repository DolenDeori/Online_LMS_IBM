    ...
    <main>
      ...
      <section className="p-4 flex justify-center w-[50%]  m-auto items-center rounded-2xl font-funnel">
        <div className="flex gap-2">
          <button
            className="hover:bg-gray-100 h-12 w-13 rounded-xl flex justify-center items-center cursor-pointer duration-150 relative"
            onMouseEnter={() => setShowNavLink("back")}
            onMouseLeave={() => setShowNavLink(null)}
            onClick={() => navigate("/")}
          >
            <div className="bg-gray-300 h-8 w-8 rounded-md flex justify-center items-center cursor-pointer duration-150">
              <i className="bi bi-caret-left-fill"></i>
            </div>
            {showNavLink === "back" && (
              <p className="absolute right-14 bg-gray-900 font-funnel font-normal text-white text-sm px-2 py-1 rounded-xl z-1">
                Home
              </p>
            )}
          </button>
              ...
              <div className="flex flex-col h-full gap-8">
                ...
                <div>
                  ...
                  <p className=" line-clamp-4 mt-2">
                    ...
                    aperiam dignissimos excepturi ut qui cum ullam adipisci
                    fugiat expedita architecto rerum natus, quae itaque ab
                    aliquam. Impedit doloribus harum odit aliquid, tenetur rem
                    iure eligendi debitis nam nostrum soluta dolorem numquam eos
                    error. Corporis repellat incidunt doloremque nostrum!
                    Excepturi, provident delectus fuga quas et recusandae
                    consequuntur sint ex?
                  </p>
                </div>
              </div>
